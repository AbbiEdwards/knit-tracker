...
- **Analytics** — total hours per project (bars coloured by project colour) and hours per logged session grouped by stage *category* and yarn weight, built from your own history. Unlike the other tabs, this always includes every project regardless of deadline or status.
